...
class MultiImage(nn.Module):
    ...
    def forward(self, x):
        ...
        f = torch.cat((f1, x2, x3), dim=1)
        return self.clf(f)

def predict(model, env, env_prev, action_prev, obs_prev, i, SAVE):
    model = model.eval()
    # Get image from observation
    image, im1, im2, im3, im4, im5, im6 = get_image_from_observation(env, env_prev, i)
    ...
    transformations = transforms.Compose([
        transforms.ToTensor(),
        transforms.Normalize((0.48318733, 0.37641326, 0.35779971,0.48318733, 0.37641326, 0.35779971, 
                              0.48318733, 0.37641326, 0.35779971,0.48318733, 0.37641326, 0.35779971,
                              0.48318733, 0.37641326, 0.35779971,0.48318733, 0.37641326, 0.35779971,
                              0.48318733, 0.37641326, 0.35779971,0.48318733, 0.37641326, 0.35779971,
                              0.48318733, 0.37641326, 0.35779971,0.48318733, 0.37641326, 0.35779971,
                              0.48318733, 0.37641326, 0.35779971,0.48318733, 0.37641326, 0.35779971),
                             (0.17344827, 0.2299165,  0.23088937,0.17344827, 0.2299165,  0.23088937,
                              0.17344827, 0.2299165,  0.23088937,0.17344827, 0.2299165,  0.23088937,
                              0.17344827, 0.2299165,  0.23088937,0.17344827, 0.2299165,  0.23088937,
                              0.17344827, 0.2299165,  0.23088937,0.17344827, 0.2299165,  0.23088937,
                              0.17344827, 0.2299165,  0.23088937,0.17344827, 0.2299165,  0.23088937,
