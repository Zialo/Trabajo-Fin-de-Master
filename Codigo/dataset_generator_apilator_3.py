...
csv_train = ['SPlace_150/Train_dataset/Train_Actions.csv',
             'SPlace_50_4/Train_dataset/Train_Actions.csv']

csv_test =  ['SPlace_150/Test_dataset/Test_Actions.csv',
             'SPlace_50_4/Test_dataset/Test_Actions.csv']

csv_tam_train = ['SPlace_150/Train_dataset/Tam_pruebas_train.csv',
                 'SPlace_50_4/Train_dataset/Tam_pruebas_train.csv']

csv_tam_test =  ['SPlace_150/Test_dataset/Tam_pruebas_test.csv',
                 'SPlace_50_4/Test_dataset/Tam_pruebas_test.csv']
                 
csv_train_obs = ['SPlace_150/Train_dataset/Train_Obs.csv',
                 'SPlace_50_4/Train_dataset/Train_Obs.csv']

csv_test_obs =  ['SPlace_150/Test_dataset/Test_Obs.csv',
                 'SPlace_50_4/Test_dataset/Test_Obs.csv']
