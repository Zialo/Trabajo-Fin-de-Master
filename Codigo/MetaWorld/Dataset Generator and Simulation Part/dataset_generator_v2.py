...
for i in range(len(train_dataset)):
    ...
    print('Prueba inicio:', str(num_prueba_inicio))
    ...
    # Imagenes
    print('Train')
    print(num_prueba_inicio, num_prueba_final)
    for j in range(num_prueba_inicio, num_prueba_final):
...
df = pd.DataFrame (lista_pruebas_train)
df.to_csv('Train_dataset' + NUM + '/Tam_pruebas_train.csv', index=False)

df = pd.DataFrame (lista_pruebas_test)
