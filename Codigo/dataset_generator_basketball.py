        ...
        with iio.get_writer(NAME + "/data_" + str(prob) + "_.gif", mode="I", fps=30) as writer:
            ...
            for i in tqdm.tqdm(range(ITS)):
                ...
                if near_object == 1.0 or near_object2 >= 0.90:
                    cont_near_object += 1
                print('PRUEBA: ', str(pruebas), 'Near_object: ', str(near_object), 'Cont_Near_Object: ',str(cont_near_object), "\n")
                ...
                print('Size of ENV OBJECT: {}'.format(sys.getsizeof(env)))
                print('Size of POLICY OBJECT: {}'.format(sys.getsizeof(policy)))
                print('Size of TQDM OBJECT: {}'.format(sys.getsizeof(tqdm)))
                print('Size of OBS OBJECT: {}'.format(sys.getsizeof(obs)))
                print('Size of IMAGEN_RGB OBJECT: {}'.format(sys.getsizeof(img_topview)))
                print('Size of LISTA_OBS OBJECT: {}'.format(sys.getsizeof(obs_list)))
                print('Size of LISTA_ACCIONES OBJECT: {}'.format(sys.getsizeof(action_list)))
                print('Size of IIO OBJECT: {}'.format(sys.getsizeof(iio)))
